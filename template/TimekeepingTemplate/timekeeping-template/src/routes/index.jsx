...
const Login = async(() => import("../pages/security/Login"));
const QrCheckin = async(() => import("../pages/qrCheckin"));
const Overview = async(() => import("../pages/admin/SCR005/Overview"));
const Personnel = async(() => import("../pages/admin/SCR006/Personnel"));
const Statistical = async(() => import("../pages/admin/SCR008/Statistical"));
const Calendar = async(() => import("../pages/admin/SCR010/Calendar"));
const Detail = async(() => import("../pages/admin/SCR007/Detail"));
const ForgetPassword=  async(() => import("../pages/security/ForgetPassword"));
